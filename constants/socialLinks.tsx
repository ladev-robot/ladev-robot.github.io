...
export const socialLinks = [
  {
    id: 1,
    title: `${siteConfig.name}'s Github Profile`,
  ...
  {
    id: 2,
    title: `${siteConfig.name}'s LinkedIn Profile`,
  ...
  {
    id: 3,
    title: `Check ${siteConfig.name} on Dev.to`,
    link: siteConfig.social.devto,
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    id: 4,
    title: `${siteConfig.name}'s Profile on Facebook`,
